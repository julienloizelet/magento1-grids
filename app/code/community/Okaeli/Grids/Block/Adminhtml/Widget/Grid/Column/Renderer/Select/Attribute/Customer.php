 ...
 *
 */
class Okaeli_Grids_Block_Adminhtml_Widget_Grid_Column_Renderer_Select_Attribute_Customer extends
    Okaeli_Grids_Block_Adminhtml_Widget_Grid_Column_Renderer_Select_Attribute
{
     ...
     * @var string
     */
    protected $_resourceModelClass = 'customer/attribute_collection';
