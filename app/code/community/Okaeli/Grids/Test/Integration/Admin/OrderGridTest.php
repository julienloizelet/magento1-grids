 ...
 *
 */
class Okaeli_Grids_Test_Integration_Admin_OrderGridTest
    extends Okaeli_Grids_Test_Integration_Admin_Abstract
{
    ...
    {
        $this->_testDisableAllFeature(Okaeli_Grids_Helper_Config::ORDER_TYPE);
    }
    ...
    {
        $this->_testDisableFeature(Okaeli_Grids_Helper_Config::ORDER_TYPE);
    }
    ...
    {
        $this->_testGoodAttributeSettings('customer_id', Okaeli_Grids_Helper_Config::ORDER_TYPE);
    }
    ...
    {
        $this->_testBadAttributeSettings(Okaeli_Grids_Helper_Config::ORDER_TYPE);
    }
